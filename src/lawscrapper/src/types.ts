/**
 * Codes des groupes politiques de la 17ème législature
 */
export enum GroupePolitiqueCode {
  RN = 'RN',              // Rassemblement National
  LFI_NFP = 'LFI-NFP',    // La France insoumise - Nouveau Front Populaire
  SOC = 'SOC',            // Socialistes et apparentés
  ECO = 'ECO',            // Écologiste et Social
  GDR = 'GDR',            // Gauche Démocrate et Républicaine
  EPR = 'EPR',            // Ensemble pour la République
  DEM = 'DEM',            // Les Démocrates (MoDem et Indépendants)
  HOR = 'HOR',            // Horizons et apparentés
  DR = 'DR',              // Droite Républicaine
  UDR = 'UDR',            // Union des droites pour la République
  NI = 'NI',              // Non inscrits
  UNKNOWN = 'UNKNOWN',    // Groupe non identifié
}
