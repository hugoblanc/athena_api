...
@Module({
    ...
    controllers: [AppController, MediaController, GithubController],
    providers: [AppService, CronService, ExternalService, PostService, NotificationService, MediaService, GithubService],
})
